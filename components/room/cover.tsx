...
export default function cover() {
  return (
    <>
      ...
      >
        <SwiperSlide>
          <Image src="/assets/images/cover1.png" alt="logo" width={962} height={488} priority={true} />
        </SwiperSlide>
        <SwiperSlide>
          <Image src="/assets/images/cover1.png" alt="logo" width={962} height={488} priority={true}/>
        </SwiperSlide>
        ...
        <SwiperSlide>
          <Image src="/assets/images/room.png" alt="logo" width={1170} height={588} priority={true}/>
        </SwiperSlide>
